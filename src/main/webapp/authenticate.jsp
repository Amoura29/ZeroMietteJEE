                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <form action="./Controller" method="post" class="was-validated"  >
                            ...
                            <div class="mb-3"> 
                                <div class="form-floating">
                                    <input type="password" name="password" id="password" class="form-control" minlength="6" placeholder="" required /> 
                            ...
                            <button type="submit" class="btn btn-primary text-white w-100" style="font-size: 32px;font-weight: 600;">sign in</button>
